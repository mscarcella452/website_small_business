...
function HeroSection() {
  ...
  return (
    ...
    >
      <Grid
        container
        columns={{ xxs: 1, sm: 2, lg: 3 }}
        sx={{ width: 1, height: 1, maxHeight: 600, px: 4 }}
      >
        {[image, image, image].map((img, index) => (
          <Grid
            ...
            // spacing={{ xxs: 1, sm: 2, lg: 10 }}
            sx={
              {
                // padding: 2,
                // display: index === 0 && { xxs: "grid", sm: "none", lg: "grid" },
              }
            }
          >
            {[image, image, image].map((img, index) => (
              <Grid
                container
                xxs={1}
                columns={{ xxs: 1, sm: 2, lg: 2 }}
                // spacing={{ xxs: 1, sm: 2, lg: 1 }}
                sx={{ px: 2 }}
              >
                {[image, image, image].map((img, index) => (
                  <Grid
