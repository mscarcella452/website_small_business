...
export default function NavMenuDrawer({
  ...
  return (
    <Box
      sx={{
        zIndex: 100,
        // zIndex: open ? navbar_zIndex + 1 : -1,
        position: "fixed",
        top: 0,
        right: 0,
        left: 0,
        bottom: 0,
        // backgroundColor: transition ? "rgba(0, 0, 0, 0.5)" : "transparent",
        // // opacity: open ? 1 : 0,
    ...
    >
      ...
      <Box
        ...
        sx={{ height: transition ? 1 : 0, backgroundColor: "fontColor.p" }}
      >
        <MenuContentBox
          className='flexColumn'
          variant='fullWidth'
